...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RosterlyApi.Entities.SignupAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RosterlyApi.Entities.SignupQuestion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("RosterlyApi.Entities.SignupAnswer", b =>
                {
                    b.HasOne("RosterlyApi.Entities.SignupQuestion", "Question")
                        .WithMany("Answers")
                        .HasForeignKey("QuestionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RosterlyApi.Entities.Signup", "Signup")
                        .WithMany("Answers")
