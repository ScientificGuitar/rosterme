...
export interface paths {
    ...
    "/api/signup/manage/{token}/confirm": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["SuperAdminStatsResponse"];
                    };
                };
                /** @description Unauthorized */
                401: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["SuperAdminActivityResponse"];
                    };
                };
                /** @description Bad Request */
                400: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["SuperAdminRecentResponse"];
                    };
                };
                /** @description Bad Request */
                400: {
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": components["schemas"]["SuperAdminOutboxListResponse"];
                    };
                };
                /** @description Bad Request */
                400: {
...
export interface components {
    schemas: {
        ...
        SuperAdminActivityResponse: {
            signupsPerDay: components["schemas"]["DayCount"][];
            eventsPerDay: components["schemas"]["DayCount"][];
        };
        SuperAdminEventRow: {
            /** Format: uuid */
            id: string;
        ...
        SuperAdminOutboxListResponse: {
            ...
            /** Format: int32 */
            take: number | string;
            items: components["schemas"]["SuperAdminOutboxRow"][];
        };
        SuperAdminOutboxRow: {
            /** Format: uuid */
            id: string;
        ...
        SuperAdminRecentResponse: {
            groups: components["schemas"]["SuperAdminGroupRow"][];
            events: components["schemas"]["SuperAdminEventRow"][];
            signups: components["schemas"]["SuperAdminSignupRow"][];
        };
        SuperAdminSignupRow: {
            /** Format: uuid */
            id: string;
        ...
        SuperAdminStatsResponse: {
            ...
            /** Format: int32 */
            inviteLinks: number | string;
            /** Format: int32 */
            owners: number | string;
            /** Format: int32 */
            emailsPending: number | string;
            /** Format: int32 */
            emailsSent: number | string;
            /** Format: double */
            capacityFillRate: number | string;
            signupsByStatus: {
